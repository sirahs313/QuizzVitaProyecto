...
.progress {
    ...
    color: white;
    font-weight: bold;
    transition: width 0.5s ease-in-out; /* Añade una transición suave */
}
        ...
        <div class="container">
            ...
            <div class="result-box">
                ...
                <div class="progress-bar">
                    <div class="progress" style="width:<%= Request.QueryString["score"] %>%;">
                <!-- Barra de progreso -->
                <div class="progress-bar">
            ...
            <p>Tus resultados indican que podrías estar experimentando síntomas de estrés severo...</p>
        </div>
    </form>
</body>
</html>

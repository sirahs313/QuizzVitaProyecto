<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QEstres.aspx.cs" Inherits="QuizzVitaProyecto.QuizzEstres.QEstres" %>
    ...
    <div class="container" style="padding-top: 5%; margin-bottom: 5%;">
        <div id="Encabezado" class="row justify-content-center">
            ...
            <div id="advertencia" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center" style="margin-top: 3%; text-align: center;">
                <p>Lea cada oración y después decida qué respuesta representa mejor su situación. No hay respuestas correctas o incorrectas.
                    <br />
                    <i>Este Quizz está diseñado como un prediagnóstico; para corroborar sus resultados consulte con un especialista.</i></p>
            </div>
        </div>
